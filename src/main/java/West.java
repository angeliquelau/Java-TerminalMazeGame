...
public class West implements Movement
{
    ...
    public West(int newUpdatedRow, int newUpdatedCol, Player inPlayer, Key inKey, Door inDoor)
    {
    ...
    public int updatePCol(int userRowPos, int userColPos, int bRow, int bCol, String[][] mapStr) throws AssignmentException
    {
        ...
        if(mapStr[userRowPos][userColPos - 2] != "\u2502" && userColPos >= 1)
        {
        ...
        else //othewise, tell user cannot go right
        {
